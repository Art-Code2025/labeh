              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="w-10 h-10 bg-gradient-to-br from-pink-500 to-yellow-500 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:shadow-lg text-white"
                    title="انستجرام"
                  >
                    <div className="w-6 h-6">
