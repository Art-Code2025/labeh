                        ...
                        {service.categoryName?.includes('خارجية') ? (
                          <div className="space-y-2">
                            <div className="flex flex-col gap-1.5">
                              <div className="flex items-center justify-between bg-green-50 px-2.5 py-1.5 rounded-md border border-green-100">
                                <div className="flex items-center gap-1.5">
                                  <span className="bg-green-100 text-green-700 text-xs font-medium px-2 py-0.5 rounded-md">خميس مشيط</span>
                                </div>
                                <span className="text-green-700 font-medium text-sm">250 ريال</span>
                              </div>
                              <div className="flex items-center justify-between bg-green-50 px-2.5 py-1.5 rounded-md border border-green-100">
                                <div className="flex items-center gap-1.5">
                                  <span className="bg-green-100 text-green-700 text-xs font-medium px-2 py-0.5 rounded-md">أبها</span>
                                </div>
                                <span className="text-green-700 font-medium text-sm">300 ريال</span>
                              </div>
                            </div>
                          </div>
                        ) : (
